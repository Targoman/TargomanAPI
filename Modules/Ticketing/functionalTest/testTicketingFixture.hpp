...
#ifndef TEST_TICKETINGFIXTURE_HPP
#define TEST_TICKETINGFIXTURE_HPP
...
class testTicketingFixture : public clsBaseTest
{
    Q_OBJECT

public:
    testTicketingFixture(const QString &_dbPrefix) : clsBaseTest(_dbPrefix) { ; }
...
private slots:
    ...
    void setupTicketingFixture() {
        QT_TRY {
            QVariant Result = callAdminAPI(
                RESTClientHelper::POST,
                "Ticketing/fixtureSetup",
                {},
                {
                    { "random", this->LastRandomNumber },
                });

            qDebug() << "--------- Ticketing fixtureSetup: " << Result;
...
private slots:
    ...
    /* cleanup *****************************************************************************/
    /***************************************************************************************/
    void cleanupTicketingFixture() {
        QT_TRY {
            QVariant Result = callAdminAPI(
                RESTClientHelper::POST,
                "Ticketing/fixtureCleanup",
                {},
                {
                    { "random", this->LastRandomNumber },
                });

            qDebug() << "--------- Ticketing fixtureCleanup: " << Result;
...
#endif // TEST_TICKETINGFIXTURE_HPP
