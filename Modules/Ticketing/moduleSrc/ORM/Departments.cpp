...
QVariant IMPL_ORMGET_ANONYMOUSE(Departments) {
//    Authorization::checkPriv(APICALLBOOM_PARAM, this->privOn(EHTTP_GET, this->moduleBaseName()));
    return this->Select(GET_METHOD_ARGS_CALL_VALUES);
}

quint32 IMPL_ORMCREATE_USER(Departments) {
...
bool IMPL_ORMUPDATE_USER(Departments) {
...
bool IMPL_ORMDELETE_USER(Departments) {
