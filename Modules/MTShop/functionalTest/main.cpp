...
#include "testMTShop.hpp"
#include "testMTShopFixture.hpp"

TAPI_MARSHAL_TEST_VARIABLES

int main(int _argc, char *_argv[]) {
    qDebug() << "--------------------------------------------------";
    qDebug() << "-- test module: MTShop ---------------------------";
    qDebug() << "--------------------------------------------------";
    ...
    try {
        ...
        if (BreakOnFirstFail && !FailedTests) FailedTests += QTest::qExec(new testMTShop(DBPrefix), progArgsCount, progArgs);
//        if (BreakOnFirstFail && !FailedTests) FailedTests += QTest::qExec(new testMTShopFixture(DBPrefix), progArgsCount, progArgs);
