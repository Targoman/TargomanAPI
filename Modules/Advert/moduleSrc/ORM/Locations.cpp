...
QVariant Locations::apiGET(APISession<true> &_SESSION, GET_METHOD_ARGS_IMPL_APICALL) {
...
quint32 Locations::apiCREATE(APISession<true> &_SESSION, CREATE_METHOD_ARGS_IMPL_APICALL) {
...
bool Locations::apiUPDATE(APISession<true> &_SESSION, UPDATE_METHOD_ARGS_IMPL_APICALL) {
...
bool Locations::apiDELETE(APISession<true> &_SESSION, DELETE_METHOD_ARGS_IMPL_APICALL) {
