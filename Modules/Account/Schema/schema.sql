...
CREATE TABLE IF NOT EXISTS `tblActionLogs` (
  `atlID` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table AAA.tblActionLogs: ~242 rows (approximately)
...
-- Dumping data for table AAA.tblActiveSessions: ~1 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `tblAPITokens` (
  ...
  CONSTRAINT `FK_tblAPIToken_tblUser_3` FOREIGN KEY (`aptUpdatedBy_usrID`) REFERENCES `tblUser` (`usrid`) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `tblApprovalRequest` (
  ...
  `aprRequestedFor` char(1) NOT NULL DEFAULT 'E' COMMENT 'E: Email, M: Mobile',
  `aprApprovalCode` varchar(50) NOT NULL,
  `aprApprovalValue` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tblOfflinePayments` (
  ...
  `ofp_vchID` bigint(20) unsigned NOT NULL,
  ...
  `ofpNotes` varchar(500) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tblOnlinePayments` (
  ...
  `onpPaymentGateway` char(1) NOT NULL DEFAULT 'Z' COMMENT 'Z: Zibal, ZarrinPal, N:NextPay, O: Pardano, P:Parsian, M:Mellat, G:Padsargad, S:Saman, A:AsanPardakht, W:Gap, V:VISA, C: MasterCard, ',
...
-- Dumping data for table AAA.tblRoles: ~5 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `tblUser` (
  ...
  `usr_rolID` int(10) unsigned NOT NULL,
...
-- Dumping data for table AAA.tblUser: ~9 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `tblUserExtraInfo` (
  ...
  `ueiIBAN` varchar(50) DEFAULT NULL,
  `ueiEther` varchar(50) DEFAULT NULL,
  `ueiPhoto` longtext,
...
CREATE TABLE IF NOT EXISTS `tblUserWallets` (
  ...
  `walMinBalance` bigint(20) unsigned NOT NULL DEFAULT '0',
  `walNotTransferableAmount` bigint(20) unsigned NOT NULL DEFAULT '0',
  `walMaxTransferPerDay` bigint(20) unsigned NOT NULL DEFAULT '10000000',
  `walLastBalance` bigint(20) NOT NULL DEFAULT '0',
  `walSumIncome` bigint(20) unsigned NOT NULL DEFAULT '0',
  `walSumExpenses` bigint(20) unsigned NOT NULL DEFAULT '0',
  `walSumCredit` bigint(20) unsigned NOT NULL DEFAULT '0',
  `walSumDebit` bigint(20) unsigned NOT NULL DEFAULT '0',
...
-- Dumping data for table AAA.tblUserWallets: ~8 rows (approximately)
/*!40000 ALTER TABLE `tblUserWallets` DISABLE KEYS */;
INSERT INTO `tblUserWallets` (`wal_usrID`, `walName`, `walDefault`, `walCreatedBy_usrID`) VALUES
        (100, 'default', b'1', 100);
...
CREATE TABLE IF NOT EXISTS `tblWalletBalances` (
  ...
  `wblSumIncome` bigint(20) unsigned NOT NULL DEFAULT '0',
  `wblSumExpense` bigint(20) unsigned NOT NULL DEFAULT '0',
  `wblSumCredit` bigint(20) unsigned NOT NULL DEFAULT '0',
  `wblSumDebit` bigint(20) unsigned NOT NULL DEFAULT '0',
