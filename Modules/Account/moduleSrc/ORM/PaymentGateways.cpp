...
QVariant PaymentGateways::apiGET(APISession<true> &_SESSION, GET_METHOD_ARGS_IMPL_APICALL) {
...
quint32 PaymentGateways::apiCREATE(APISession<true> &_SESSION, CREATE_METHOD_ARGS_IMPL_APICALL) {
...
bool PaymentGateways::apiUPDATE(APISession<true> &_SESSION, UPDATE_METHOD_ARGS_IMPL_APICALL) {
...
bool PaymentGateways::apiDELETE(APISession<true> &_SESSION, DELETE_METHOD_ARGS_IMPL_APICALL) {
