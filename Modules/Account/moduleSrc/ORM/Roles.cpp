...
QVariant Roles::apiGET(APISession<true> &_SESSION, GET_METHOD_ARGS_IMPL_APICALL) {
...
quint32 Roles::apiCREATE(APISession<true> &_SESSION, CREATE_METHOD_ARGS_IMPL_APICALL) {
...
bool Roles::apiUPDATE(APISession<true> &_SESSION, UPDATE_METHOD_ARGS_IMPL_APICALL) {
...
bool Roles::apiDELETE(APISession<true> &_SESSION, DELETE_METHOD_ARGS_IMPL_APICALL) {
