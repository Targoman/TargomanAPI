...
QVariant Service::apiGET(APISession<true> &_SESSION, GET_METHOD_ARGS_IMPL_APICALL) {
...
quint64 Service::apiCREATE(APISession<true> &_SESSION, CREATE_METHOD_ARGS_IMPL_APICALL) {
...
bool Service::apiUPDATE(APISession<true> &_SESSION, UPDATE_METHOD_ARGS_IMPL_APICALL) {
...
bool Service::apiDELETE(APISession<true> &_SESSION, DELETE_METHOD_ARGS_IMPL_APICALL) {
