...
private:
    ...
    /***************************************************************************************/
/*
TRUNCATE dev_AAA.tblActionLogs;
...
TRUNCATE dev_Ticketing.tblActionLogs;
...
//private:
    ...
    void InitAndNormalizePhoneNumber() {
        try {
            ...
            QVERIFY_DUMP_RESULT(Result.toString() == FormattedRandomPhoneNumber);
    ...
    void LoginByMobileOnly() {
        ...
        QVERIFY_DUMP_RESULT(Result.toBool());
    }
...
//                        { "fingerprint",  },
        ...
        QVERIFY_DUMP_RESULT(ResultAsMap.contains("token"));
...
//        QVERIFY_DUMP_RESULT(clsJWT(gJWT).actorID() == UserID);
    ...
    void Logout_1() {
        QVariant Result = callUserAPI(RESTClientHelper::POST, "Account/logout");
    ...
    void Signup() {
        ...
        QVariant Result = callGuestAPI(RESTClientHelper::PUT,
                                "Account/signup", {}, {
        ...
        gUserID = Result.toMap().value("usrID").toULongLong();
        QVERIFY_DUMP_RESULT(gUserID > 0);

        //df6d2338b2b8fce1ec2f6dda0a630eb0 # 987
        QVERIFY_DUMP_RESULT((gAdminUserID = callGuestAPI(RESTClientHelper::PUT,
                                        "Account/signup", {}, {
...
//        {gUserID});
        ...
        QVariantMap ResultAsMap = Result.toMap();
        QVERIFY_DUMP_RESULT(ResultAsMap.contains("userID"));
        QVERIFY_DUMP_RESULT(ResultAsMap.contains("token") == false);
    }
...
//        QVERIFY_DUMP_RESULT((MultiJWT = callRefreshAPI().toJsonObject()).size());
...
//        {Code});
        ...
        QVERIFY_DUMP_RESULT(callUserAPI(RESTClientHelper::POST,
...
//            QVERIFY_DUMP_RESULT(Mobile == this->RandomPhoneNumber2);
        } catch (std::exception &e) {
            QFAIL (e.what());
        }
    }
    ...
    void User_Photo_Get() {
        ...
        QVERIFY_DUMP_RESULT(Result.toString().isEmpty() == false);
    }
...
//                    { "wal_usrID", gAdminUserID },
            ...
            this->NewUserWalletID = Result;

            QVERIFY_DUMP_RESULT(this->NewUserWalletID > 0);
...
//                    { "fromWalID", 9876 },
    ...
    void requestWithdrawal() {
        QT_TRY {
            ...
            this->WithdrawalID = Result;

            QVERIFY_DUMP_RESULT(this->WithdrawalID > 0);
