...
//        SET_FIELD_FROM_VARIANT_MAP(cpnTotalUsedAmount,              DiscountInfo, tblAccountCouponsBase, cpnTotalUsedAmount);
        ...
        /*TAPI*/COMMON::setFromVariant(_discountUsedCount, DiscountInfo.value("_discountUsedCount"));
        NULLABLE_TYPE(quint32) _discountUsedAmount;
        /*TAPI*/COMMON::setFromVariant(_discountUsedAmount, DiscountInfo.value("_discountUsedAmount"));
