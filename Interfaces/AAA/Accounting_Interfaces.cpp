...
QVariant IMPL_ORMGET(intfAccountProducts) {
    ...
    return this->Select(*this, GET_METHOD_CALL_ARGS_INTERNAL_CALL, {}, CACHE_TIME);
}
...
//                       .arg(tblAccountSaleablesBase::slbAvailableToDate);
    ...
    constexpr quint16 CACHE_TIME = 15 * 60;
    return this->Select(*this, GET_METHOD_CALL_ARGS_INTERNAL_CALL, ExtraFilters, CACHE_TIME);
}
