...
//            deleteOldTestData();
    ...
    {
        return RESTClientHelper::callAPI(
            gEncodedJWT, _method, _api, _urlArgs, _postFields, _formFields, _formFiles, APIURL
        );
    }
    ...
    {
        return RESTClientHelper::callAPI(
            gEncodedAdminJWT, _method, _api, _urlArgs, _postFields, _formFields, _formFiles, APIURL
        );
    }
