...
intfAPIArgManipulator::intfAPIArgManipulator(const QString& _realTypeName) {
    ...
    this->PrettyTypeName = _realTypeName.startsWith(NULLABLE_QSP_M2STR_PREFIX) ? _realTypeName.mid(sizeof(NULLABLE_QSP_M2STR_PREFIX) - 1, _realTypeName.size() - static_cast<int>(sizeof(NULLABLE_QSP_M2STR_PREFIX))) : _realTypeName;
