...
#define TAPI_HELEPER_VARIANTSTRUCT_PARAMS21(t, n, d, i, to, fr, ...) t n; TAPI_HELEPER_VARIANTSTRUCT_PARAMS20(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_PARAMS22(t, n, d, i, to, fr, ...) t n; TAPI_HELEPER_VARIANTSTRUCT_PARAMS21(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_PARAMS23(t, n, d, i, to, fr, ...) t n; TAPI_HELEPER_VARIANTSTRUCT_PARAMS22(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_PARAMS24(t, n, d, i, to, fr, ...) t n; TAPI_HELEPER_VARIANTSTRUCT_PARAMS23(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_PARAMS25(t, n, d, i, to, fr, ...) t n; TAPI_HELEPER_VARIANTSTRUCT_PARAMS24(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_PARAMS26(t, n, d, i, to, fr, ...) t n; TAPI_HELEPER_VARIANTSTRUCT_PARAMS25(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_PARAMS27(t, n, d, i, to, fr, ...) t n; TAPI_HELEPER_VARIANTSTRUCT_PARAMS26(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_PARAMS28(t, n, d, i, to, fr, ...) t n; TAPI_HELEPER_VARIANTSTRUCT_PARAMS27(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_PARAMS29(t, n, d, i, to, fr, ...) t n; TAPI_HELEPER_VARIANTSTRUCT_PARAMS28(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_PARAMS30(t, n, d, i, to, fr, ...) t n; TAPI_HELEPER_VARIANTSTRUCT_PARAMS29(__VA_ARGS__)
...
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT21(t, n, d, i, to, fr, ...) const t& _##n=d, TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT20(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT22(t, n, d, i, to, fr, ...) const t& _##n=d, TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT21(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT23(t, n, d, i, to, fr, ...) const t& _##n=d, TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT22(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT24(t, n, d, i, to, fr, ...) const t& _##n=d, TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT23(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT25(t, n, d, i, to, fr, ...) const t& _##n=d, TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT24(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT26(t, n, d, i, to, fr, ...) const t& _##n=d, TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT25(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT27(t, n, d, i, to, fr, ...) const t& _##n=d, TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT26(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT28(t, n, d, i, to, fr, ...) const t& _##n=d, TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT27(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT29(t, n, d, i, to, fr, ...) const t& _##n=d, TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT28(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT30(t, n, d, i, to, fr, ...) const t& _##n=d, TAPI_HELEPER_VARIANTSTRUCT_CONS_INPUT29(__VA_ARGS__)
...
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT21(t,n,d,i,to,fr, ...) n(_##n), TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT20(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT22(t,n,d,i,to,fr, ...) n(_##n), TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT21(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT23(t,n,d,i,to,fr, ...) n(_##n), TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT22(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT24(t,n,d,i,to,fr, ...) n(_##n), TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT23(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT25(t,n,d,i,to,fr, ...) n(_##n), TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT24(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT26(t,n,d,i,to,fr, ...) n(_##n), TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT25(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT27(t,n,d,i,to,fr, ...) n(_##n), TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT26(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT28(t,n,d,i,to,fr, ...) n(_##n), TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT27(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT29(t,n,d,i,to,fr, ...) n(_##n), TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT28(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT30(t,n,d,i,to,fr, ...) n(_##n), TAPI_HELEPER_VARIANTSTRUCT_CONS_INIT29(__VA_ARGS__)
...
#define TAPI_HELEPER_VARIANTSTRUCT_TOJSON21(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_TOJSON_METHOD(n, i, to); TAPI_HELEPER_VARIANTSTRUCT_TOJSON20(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_TOJSON22(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_TOJSON_METHOD(n, i, to); TAPI_HELEPER_VARIANTSTRUCT_TOJSON21(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_TOJSON23(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_TOJSON_METHOD(n, i, to); TAPI_HELEPER_VARIANTSTRUCT_TOJSON22(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_TOJSON24(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_TOJSON_METHOD(n, i, to); TAPI_HELEPER_VARIANTSTRUCT_TOJSON23(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_TOJSON25(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_TOJSON_METHOD(n, i, to); TAPI_HELEPER_VARIANTSTRUCT_TOJSON24(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_TOJSON26(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_TOJSON_METHOD(n, i, to); TAPI_HELEPER_VARIANTSTRUCT_TOJSON25(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_TOJSON27(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_TOJSON_METHOD(n, i, to); TAPI_HELEPER_VARIANTSTRUCT_TOJSON26(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_TOJSON28(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_TOJSON_METHOD(n, i, to); TAPI_HELEPER_VARIANTSTRUCT_TOJSON27(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_TOJSON29(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_TOJSON_METHOD(n, i, to); TAPI_HELEPER_VARIANTSTRUCT_TOJSON28(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_TOJSON30(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_TOJSON_METHOD(n, i, to); TAPI_HELEPER_VARIANTSTRUCT_TOJSON29(__VA_ARGS__)
...
#define TAPI_HELEPER_VARIANTSTRUCT_FROMJSON21(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_FROMJSON_METHOD(t, n, d, fr); TAPI_HELEPER_VARIANTSTRUCT_FROMJSON20(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_FROMJSON22(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_FROMJSON_METHOD(t, n, d, fr); TAPI_HELEPER_VARIANTSTRUCT_FROMJSON21(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_FROMJSON23(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_FROMJSON_METHOD(t, n, d, fr); TAPI_HELEPER_VARIANTSTRUCT_FROMJSON22(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_FROMJSON24(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_FROMJSON_METHOD(t, n, d, fr); TAPI_HELEPER_VARIANTSTRUCT_FROMJSON23(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_FROMJSON25(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_FROMJSON_METHOD(t, n, d, fr); TAPI_HELEPER_VARIANTSTRUCT_FROMJSON24(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_FROMJSON26(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_FROMJSON_METHOD(t, n, d, fr); TAPI_HELEPER_VARIANTSTRUCT_FROMJSON25(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_FROMJSON27(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_FROMJSON_METHOD(t, n, d, fr); TAPI_HELEPER_VARIANTSTRUCT_FROMJSON26(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_FROMJSON28(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_FROMJSON_METHOD(t, n, d, fr); TAPI_HELEPER_VARIANTSTRUCT_FROMJSON27(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_FROMJSON29(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_FROMJSON_METHOD(t, n, d, fr); TAPI_HELEPER_VARIANTSTRUCT_FROMJSON28(__VA_ARGS__)
#define TAPI_HELEPER_VARIANTSTRUCT_FROMJSON30(t,n,d,i,to,fr,...) TAPI_HELEPER_DEFINE_VARIANT_STRUCT_FROMJSON_METHOD(t, n, d, fr); TAPI_HELEPER_VARIANTSTRUCT_FROMJSON29(__VA_ARGS__)
