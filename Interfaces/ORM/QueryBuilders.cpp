...
{
public:
    clsConditionData(QString _col, enuConditinOperator::Type _operator = enuConditinOperator::Null, QVariant _value = {}) :
...
public:
    QString Col;
    enuConditinOperator::Type Operator;
    QVariant Value;
...
clsCondition::clsCondition(QString _col, enuConditinOperator::Type _operator, QVariant _value) : Data(new clsConditionData(_col, _operator, _value)){;}
...
QVariant SelectQuery::one(QVariantList _args)
{
    this->Data->prepare();
...
QVariant SelectQuery::one(QVariantMap _args)
{
    this->Data->prepare();
...
TAPI::stuTable SelectQuery::all(QVariantList _args, quint16 _maxCount, quint64 _from)
{
    this->Data->prepare();
...
SelectQuery &SelectQuery::cols(const QStringList &_cols)
{
