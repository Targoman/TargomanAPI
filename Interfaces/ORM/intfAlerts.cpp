...
intfAlerts::intfAlerts() :
    clsTable(
        ...
        {///< ColName                           Type                                        Validation                  Default     UpBy       Sort    Filter  Self    Virt    PK      Select  RenameAs
            ...
            { tblAlerts::alrEmail,              S(NULLABLE_TYPE(TAPI::String_t)),           QFV.maxLenght(50),          QNull,      UPOwner },
            { tblAlerts::alrMobile,             S(NULLABLE_TYPE(TAPI::String_t)),           QFV.maxLenght(50),          QNull,      UPOwner },
