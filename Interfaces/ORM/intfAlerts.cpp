...
intfAlerts::intfAlerts() :
    clsTable(
        ...
        {///< ColName                           Type                                        Validation                  Default     UpBy       Sort    Filter  Self    Virt    PK      Select  RenameAs
            ...
            { tblAlerts::alrEmail,              S(NULLABLE_TYPE(COMMON::String_t)),           QFV.maxLenght(50),          QNull,      UPOwner },
            { tblAlerts::alrMobile,             S(NULLABLE_TYPE(COMMON::String_t)),           QFV.maxLenght(50),          QNull,      UPOwner },
            { tblAlerts::alrReplacedContactInfo,S(COMMON::String_t),                          QFV.maxLenght(50),          QNull,      UPAdmin },
            { tblAlerts::alr_altCode,           S(COMMON::String_t),                          QFV.maxLenght(50),          QRequired,  UPAdmin },
            { tblAlerts::alrReplacements,       S(COMMON::DBText_t),                          QFV,                        QRequired,  UPAdmin },
