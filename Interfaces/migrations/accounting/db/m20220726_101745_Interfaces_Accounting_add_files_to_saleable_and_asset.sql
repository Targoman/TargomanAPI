...
CREATE TABLE `tblAccountSaleablesFiles` (
    ...
    INDEX `FK_tblAccountSaleablesFiles_tblAccountSaleables` (`slf_slbID`) USING BTREE,
    CONSTRAINT `FK_tblAccountSaleablesFiles_tblAccountSaleables` FOREIGN KEY (`slf_slbID`) REFERENCES `tblAccountSaleables` (`slbID`) ON UPDATE NO ACTION ON DELETE CASCADE
)
...
CREATE TABLE `tblAccountUserAssets_files` (
    ...
    INDEX `FK_tblAccountUserAssets_files_tblAccountSaleablesFiles` (`uasufl_slfID`) USING BTREE,
    CONSTRAINT `FK_tblAccountUserAssets_files_tblAccountSaleablesFiles` FOREIGN KEY (`uasufl_slfID`) REFERENCES `tblAccountSaleablesFiles` (`slfID`) ON UPDATE NO ACTION ON DELETE NO ACTION,
