...
class gtwMarianTransBPE_v1_10 : public gtwMarianTransBPE_v1_6
{
public:
    constexpr static char Name[] = "MarianTransBPE_v1_10";

    TARGOMAN_API_MT_GATEWAY_DEFINE(gtwMarianTransBPE_v1_10)
