...
stuAdvert Advert::getNewBanner(const RemoteIP_t& _REMOTE_IP, const QString& _location, enuAdvertOrder::Type _order)
{
...
stuAdvert Advert::getNewText(const RemoteIP_t& _REMOTE_IP, const QString& _location, enuAdvertOrder::Type _order, const QString _keywords)
{

}

QString Advert::retrieveURL(const RemoteIP_t& _REMOTE_IP, quint64 _id, IPv4_t _clientIP, QString _agent)
{
